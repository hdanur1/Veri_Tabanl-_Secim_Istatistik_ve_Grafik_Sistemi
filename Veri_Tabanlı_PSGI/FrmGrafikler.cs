...
namespace Veri_Tabanlı_PSGI
{
    public partial class FrmGrafikler : Form
    {
        ...
        private void FrmGrafikler_Load(object sender, EventArgs e)
        {
            ...
            //ilçe adlarını comboboxa cekmek.
            ...
            //grafiğe toplam sonuçları getirmek
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            while (dr.Read())
            {
                pgbA.Value = int.Parse(dr[2].ToString());
                pgbB.Value = int.Parse(dr[3].ToString());
                pgbC.Value = int.Parse(dr[4].ToString());
                pgbD.Value = int.Parse(dr[5].ToString());
                pgbE.Value = int.Parse(dr[6].ToString());
